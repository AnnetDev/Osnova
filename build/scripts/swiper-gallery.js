...
// source/scripts/swiper-gallery.js
function initializeGallerySwiper() {
  ...
  if (prevButton && nextButton) {
    ...
    prevButton.addEventListener("keydown", (event2) => {
      if (event2.key === "Enter") {
        gallerySwiper.slidePrev();
      }
    });
    nextButton.addEventListener("keydown", (event2) => {
      if (event2.key === "Enter") {
...
//# sourceMappingURL=swiper-gallery.js.map
